...
public class URL {
    ...
    public String getVersion() {
        return getParameter(URLParamName.version.getName(), URLParamName.version.getValue());
    }

    public String getGroup() {
        return getParameter(URLParamName.group.getName(), URLParamName.group.getValue());
    }
